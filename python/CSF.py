...
class VecVecDouble(object):
    ...
    def iterator(self):
        return _CSF.VecVecDouble_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _CSF.VecVecDouble___nonzero__(self)

    def __bool__(self):
        return _CSF.VecVecDouble___bool__(self)

    def __len__(self):
        return _CSF.VecVecDouble___len__(self)

    def __getslice__(self, i, j):
        return _CSF.VecVecDouble___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _CSF.VecVecDouble___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _CSF.VecVecDouble___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _CSF.VecVecDouble___delitem__(self, *args)

    def __getitem__(self, *args):
        return _CSF.VecVecDouble___getitem__(self, *args)

    def __setitem__(self, *args):
        return _CSF.VecVecDouble___setitem__(self, *args)

    def pop(self):
        return _CSF.VecVecDouble_pop(self)

    def append(self, x):
        return _CSF.VecVecDouble_append(self, x)

    def empty(self):
        return _CSF.VecVecDouble_empty(self)

    def size(self):
        return _CSF.VecVecDouble_size(self)

    def swap(self, v):
        return _CSF.VecVecDouble_swap(self, v)

    def begin(self):
        return _CSF.VecVecDouble_begin(self)

    def end(self):
        return _CSF.VecVecDouble_end(self)

    def rbegin(self):
        return _CSF.VecVecDouble_rbegin(self)

    def rend(self):
        return _CSF.VecVecDouble_rend(self)

    def clear(self):
        return _CSF.VecVecDouble_clear(self)

    def get_allocator(self):
        return _CSF.VecVecDouble_get_allocator(self)

    def pop_back(self):
        return _CSF.VecVecDouble_pop_back(self)

    def erase(self, *args):
        return _CSF.VecVecDouble_erase(self, *args)

    def __init__(self, *args):
        _CSF.VecVecDouble_swiginit(self, _CSF.new_VecVecDouble(*args))

    def push_back(self, x):
        return _CSF.VecVecDouble_push_back(self, x)

    def front(self):
        return _CSF.VecVecDouble_front(self)

    def back(self):
        return _CSF.VecVecDouble_back(self)

    def assign(self, n, x):
        return _CSF.VecVecDouble_assign(self, n, x)

    def resize(self, *args):
        return _CSF.VecVecDouble_resize(self, *args)

    def insert(self, *args):
        return _CSF.VecVecDouble_insert(self, *args)

    def reserve(self, n):
        return _CSF.VecVecDouble_reserve(self, n)

    def capacity(self):
        return _CSF.VecVecDouble_capacity(self)
    __swig_destroy__ = _CSF.delete_VecVecDouble

# Register VecVecDouble in _CSF:
_CSF.VecVecDouble_swigregister(VecVecDouble)
...
class VecVecVecFloat(object):
    ...
    def iterator(self):
        return _CSF.VecVecVecFloat_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _CSF.VecVecVecFloat___nonzero__(self)

    def __bool__(self):
        return _CSF.VecVecVecFloat___bool__(self)

    def __len__(self):
        return _CSF.VecVecVecFloat___len__(self)

    def __getslice__(self, i, j):
        return _CSF.VecVecVecFloat___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _CSF.VecVecVecFloat___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _CSF.VecVecVecFloat___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _CSF.VecVecVecFloat___delitem__(self, *args)

    def __getitem__(self, *args):
        return _CSF.VecVecVecFloat___getitem__(self, *args)

    def __setitem__(self, *args):
        return _CSF.VecVecVecFloat___setitem__(self, *args)

    def pop(self):
        return _CSF.VecVecVecFloat_pop(self)

    def append(self, x):
        return _CSF.VecVecVecFloat_append(self, x)

    def empty(self):
        return _CSF.VecVecVecFloat_empty(self)

    def size(self):
        return _CSF.VecVecVecFloat_size(self)

    def swap(self, v):
        return _CSF.VecVecVecFloat_swap(self, v)

    def begin(self):
        return _CSF.VecVecVecFloat_begin(self)

    def end(self):
        return _CSF.VecVecVecFloat_end(self)

    def rbegin(self):
        return _CSF.VecVecVecFloat_rbegin(self)

    def rend(self):
        return _CSF.VecVecVecFloat_rend(self)

    def clear(self):
        return _CSF.VecVecVecFloat_clear(self)

    def get_allocator(self):
        return _CSF.VecVecVecFloat_get_allocator(self)

    def pop_back(self):
        return _CSF.VecVecVecFloat_pop_back(self)

    def erase(self, *args):
        return _CSF.VecVecVecFloat_erase(self, *args)

    def __init__(self, *args):
        _CSF.VecVecVecFloat_swiginit(self, _CSF.new_VecVecVecFloat(*args))

    def push_back(self, x):
        return _CSF.VecVecVecFloat_push_back(self, x)

    def front(self):
        return _CSF.VecVecVecFloat_front(self)

    def back(self):
        return _CSF.VecVecVecFloat_back(self)

    def assign(self, n, x):
        return _CSF.VecVecVecFloat_assign(self, n, x)

    def resize(self, *args):
        return _CSF.VecVecVecFloat_resize(self, *args)

    def insert(self, *args):
        return _CSF.VecVecVecFloat_insert(self, *args)

    def reserve(self, n):
        return _CSF.VecVecVecFloat_reserve(self, n)

    def capacity(self):
        return _CSF.VecVecVecFloat_capacity(self)
    __swig_destroy__ = _CSF.delete_VecVecVecFloat

# Register VecVecVecFloat in _CSF:
_CSF.VecVecVecFloat_swigregister(VecVecVecFloat)
...
class VecVecVecDouble(object):
    ...
    def iterator(self):
        return _CSF.VecVecVecDouble_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _CSF.VecVecVecDouble___nonzero__(self)

    def __bool__(self):
        return _CSF.VecVecVecDouble___bool__(self)

    def __len__(self):
        return _CSF.VecVecVecDouble___len__(self)

    def __getslice__(self, i, j):
        return _CSF.VecVecVecDouble___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _CSF.VecVecVecDouble___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _CSF.VecVecVecDouble___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _CSF.VecVecVecDouble___delitem__(self, *args)

    def __getitem__(self, *args):
        return _CSF.VecVecVecDouble___getitem__(self, *args)

    def __setitem__(self, *args):
        return _CSF.VecVecVecDouble___setitem__(self, *args)

    def pop(self):
        return _CSF.VecVecVecDouble_pop(self)

    def append(self, x):
        return _CSF.VecVecVecDouble_append(self, x)

    def empty(self):
        return _CSF.VecVecVecDouble_empty(self)

    def size(self):
        return _CSF.VecVecVecDouble_size(self)

    def swap(self, v):
        return _CSF.VecVecVecDouble_swap(self, v)

    def begin(self):
        return _CSF.VecVecVecDouble_begin(self)

    def end(self):
        return _CSF.VecVecVecDouble_end(self)

    def rbegin(self):
        return _CSF.VecVecVecDouble_rbegin(self)

    def rend(self):
        return _CSF.VecVecVecDouble_rend(self)

    def clear(self):
        return _CSF.VecVecVecDouble_clear(self)

    def get_allocator(self):
        return _CSF.VecVecVecDouble_get_allocator(self)

    def pop_back(self):
        return _CSF.VecVecVecDouble_pop_back(self)

    def erase(self, *args):
        return _CSF.VecVecVecDouble_erase(self, *args)

    def __init__(self, *args):
        _CSF.VecVecVecDouble_swiginit(self, _CSF.new_VecVecVecDouble(*args))

    def push_back(self, x):
        return _CSF.VecVecVecDouble_push_back(self, x)

    def front(self):
        return _CSF.VecVecVecDouble_front(self)

    def back(self):
        return _CSF.VecVecVecDouble_back(self)

    def assign(self, n, x):
        return _CSF.VecVecVecDouble_assign(self, n, x)

    def resize(self, *args):
        return _CSF.VecVecVecDouble_resize(self, *args)

    def insert(self, *args):
        return _CSF.VecVecVecDouble_insert(self, *args)

    def reserve(self, n):
        return _CSF.VecVecVecDouble_reserve(self, n)

    def capacity(self):
        return _CSF.VecVecVecDouble_capacity(self)
    __swig_destroy__ = _CSF.delete_VecVecVecDouble

# Register VecVecVecDouble in _CSF:
_CSF.VecVecVecDouble_swigregister(VecVecVecDouble)
...
class CSF(object):
    ...
    def do_filtering(self, groundIndexes, offGroundIndexes, groundParticleCoords, exportCloth=False):
        return _CSF.CSF_do_filtering(self, groundIndexes, offGroundIndexes, groundParticleCoords, exportCloth)
